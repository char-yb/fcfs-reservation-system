...
Checkout API와 Booking API가 요구된 부하를 어떻게 처리하는지 검증한다.
...
| `LOCK_ACQUISITION_FAILED` 급증 | Redisson fair lock wait time, DB update latency, API 로그 |
