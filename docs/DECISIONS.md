...
이 위험들은 숨기지 않고 `docs/04-fault-tolerance.md`와 [`06-long-term-roadmap.md`](./06-long-term-roadmap.md)에서 운영 항목으로 추적한다.
